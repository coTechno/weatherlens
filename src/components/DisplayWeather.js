                                                    ...
                                                    {data.weather[0].icon == "09n" ? (
                                                      ...
                                                      <>
                                                        {data.weather[0].icon == "10d" ? (
                                                          <WiDayRainMix size={240} color="#fff" />
                                                        ) : (
                                                          <>
                                                            {data.weather[0].icon == "10n" ? (
                                                              <WiNightRainMix size={240} color="#fff" />
                                                            ) : (
                                                              <>
                                                                {data.weather[0].icon == "11d" ? (
                                                                  <WiThunderstorm size={240} color="#fff" />
                                                                ) : (
                                                                  <>
                                                                    {data.weather[0].icon == "11n" ? (
                                                                      ...
                                                                      <>
                                                                        {data.weather[0].icon == "13d" ? (
                                                                          <WiSnowflakeCold size={240} color="#fff" />
                                                                        ) : (
                                                                          <>
                  ...
                  <td>
                    <h4>
                      <svg
                        ...
                        stroke="currentColor"
                        className="w-6 h-6"
                        style={{ color: "#fff", width: '35px', marginLeft: '4px' }}
                      >
                        <path
                          strokeLinecap="round"
